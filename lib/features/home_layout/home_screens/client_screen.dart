...
class ClientScreen extends StatelessWidget {
  ...
  const ClientScreen({super.key, required this.onAddInvoicePressed});
          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width: 1,),
                CustomTableTitle(flex: 2, text: 'Address'),
                SizedBox(width: 1,),
                CustomTableTitle(flex: 2, text: 'Phone'),
                SizedBox(width: 1,),
                CustomTableTitle(flex: 1, text: 'Debtor'),
                SizedBox(width: 1,),
                CustomTableTitle(flex: 1, text: 'Creditor'),
                SizedBox(width: 1,),
                CustomTableTitle(flex: 2, text: 'Account Statement'),
                SizedBox(width: 1,),
                ...
                itemBuilder: (context,index){
                  return Row(
                    children: [
                      ...
                      SizedBox(width: 1,),
                      CustomTextInListView(flex:2,index: index, text: 'Dekerness'),
                      SizedBox(width: 1,),
                      CustomTextInListView(flex:2,index: index, text: '+96601023016939'),
                      SizedBox(width: 1,),
                      CustomTextInListView(flex:1,index: index, text: '1000'),
                      SizedBox(width: 1,),
                      CustomTextInListView(flex:1,index: index, text: '1000'),
                      SizedBox(width: 1,),
                      CustomTextInListView(flex:2,index: index, text: '1000'),
                      SizedBox(width: 1,),
